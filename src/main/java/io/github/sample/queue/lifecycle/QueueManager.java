package io.github.sample.queue.lifecycle;
...
import io.github.sample.queue.configuration.AppQueueConfiguration;
...
public class QueueManager implements Managed {
  ...
  public QueueManager(Injector injector, RabbitConnection rabbitConnection,
    ...
    final Set<Class<?>> annotatedClasses = reflections
        .getTypesAnnotatedWith(io.github.sample.queue.annotation.MessageConsumer.class);
